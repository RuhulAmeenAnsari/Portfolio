...
const Skills = () => {
  return (
    <>
      <section id="skills" className="bg-gradient-to-b from-black to-gray-900 px-20 pt-5 h-screen ">
        {/* <Spline
              ...
              <h3 className="text-2xl sm:text-3xl  font-semibold text-gray-400 mb-4 text-center">
               ...
               <div className="grid grid-cols-2 md:grid-cols-3 gap-3 w-full ">
                {category.skills.map((skill)=>(
                  <motion.div initial={{opacity:0,y:100}} animate={{opacity:1,y:0}} transition={{  type: "spring",
                  stiffness: 100,
                  damping: 25,
                  duration: 0.5,}} 
                  key={skill.name} 
